...
module Squ_server 
  class Configutation
     def self.load 
        ...
        configatron.dict = File.expand_path("../../...#{Settings.dictionary.file ||'/assets/ods.txt'}", __FILE__)    
        configatron.wikitionary = Settings.dictionary.wikitionary || false  
        configatron.web_dir = File.expand_path("../../../#{Settings.web.dir||'/lib/Web_server/scores'}", __FILE__)    
        configatron.web_bind = Settings.web_bind || '0.0.0.0'  
